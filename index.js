...
var authConfig = {
  ...
  roots: [
    ...
    {
      id: "17ABl44zcSq9XpSSHjAYFupKgfAMO0kA0",
      name: "WALLPAPER HP",
      user: "",
      pass: "",
    ...
    {
      id: "12vIthNpRGpx_iey8Cw64h7IIOTVfnfvs",
      name: "WALLPAPER LAPTOP",
      user: "",
      pass: "",
      protect_file_link: true,
    },
    {
      id: "13L0OpE2o1pR0wv1qV-dgmgxAchVLoaQS",
      name: "18+",
      user: "",
      pass: "",
      protect_file_link: true,
    ...
    {
      id: "1FOUW8GLNdlxrCbxcKW8EBUysRI-Oa1_u",
      name: "KOMIK 18+",
      user: "",
      pass: "",
      protect_file_link: true,
    ...
    {
      id: "15dPfyNLRg1Tq4uvUlQVsP5ogehz-G0Q5",
      name: "PERNAH VIRAL 18+",
      user: "",
      pass: "",
      protect_file_link: true,
    },
    {
      id: "18NAg_iTt5n88zEoMxlP0D-npUgXL1QNc",
      name: "APLIKASI PHP",
      user: "",
      pass: "",
      protect_file_link: true,
    ...
    {
      id: "1mGRZi6ycR7PD6EA5okASL7EolINX4-H1",
      name: "IMAGE",
      user: "",
      pass: "",
      protect_file_link: true,
    ...
    {
      id: "1MaP7kLgg098J02ZXqq2pzBCbmnWZYwy3",
      name: "EXCELL FILE",
      user: "",
      pass: "",
      protect_file_link: true,
    ...
    {
      id: "1--gsHz6OmdOEV4Iit6g_H3J2zQAcWy9M",
      name: "VIDEO PENDEK",
      user: "",
      pass: "",
      protect_file_link: true,
    ...
    {
      id: "1cnOlsbIAFsK6VtrNdhCyb0gvELmXmb1b",
      name: "VIDEO GORE",
      user: "",
      pass: "",
      protect_file_link: true,
    ...
    {
      id: "19rdTVMA-PTIWjUPL8Yy9s5mYQNyQbfCP",
      name: "MOVIES",
      user: "",
      pass: "",
      protect_file_link: true,
    ...
    {
      id: "1AE8Sr6Z1SlAslM1yMQZsXpJ0anM95OPi",
      name: "MP3",
      user: "",
      pass: "",
      protect_file_link: true,
    ...
    {
      id: "13DXeLqEzGJOZbNUFBt7ajbeby_TiVuog",
      name: "GAME",
      user: "",
      pass: "",
      protect_file_link: true,
    ...
    {
      id: "13JyWtM82UTGCCLyGZyPlu_H5pX_dqQ-7",
    ...
    {
      id: "1iUGyfhOMgUjKwOm2e5As-zcQE05s07zB",
      name: "SOFTWARE",
      user: "",
      pass: "",
      protect_file_link: true,
    ...
    {
      id: "14M2cD27raN03hwbOP5xXZOvQfP4rDn-3",
      name: "TUTORIAL",
      user: "",
      pass: "",
      protect_file_link: true,
    ...
    {
      id: "1DPCz53KE8R-W8iLrlbjGyPZ989fAQWJl",
      name: "WINDOWS",
      user: "",
      pass: "",
      protect_file_link: true,
    ...
    // {
    //   id: "1-oYNonjPJ9Jbodyc1n8BDH2HnqYqjbUQ",
    //   name: "SHARE",
    //   user: "",
    //   pass: "18",
    //   protect_file_link: true,
    // },
    {
      id: "1LpZLTQZ0Uj5kduJWCEmr0q1qdd7H2jR3",
      name: "FILE ICON",
      user: "",
      pass: "",
      protect_file_link: true,
    ...
    {
      id: "1dVPJZM7shG9GpnU3T4Wqw3BSMa-tPtnB",
      name: "FILE UPLOAD",
      user: "",
      pass: "",
      protect_file_link: true,
...
var themeOptions = {
  cdn: "https://cdn.jsdelivr.net/gh/Sugandi1994/INDEXDRIVEGD",
  // 主题版本号
...
<meta name="twitter:image" content="https://file.downloaderku.workers.dev/0:/Stiker_jdm_sepaket_keren_.jpg">
...
<meta name="twitter:url" content="https://file.downloaderku.workers.dev">
<link rel="shortcut icon" href="https://file.downloaderku.workers.dev/0:/Stiker_jdm_sepaket_keren_.jpg">
<meta property="og:site_name" content="Goindex">
<meta property="og:type" content="website">
<meta property="og:image" content="https://file.downloaderku.workers.dev/0:/Stiker_jdm_sepaket_keren_.jpg">
...
<meta property="og:url" content="https://file.downloaderku.workers.dev">
<link rel="apple-touch-icon" href="https://file.downloaderku.workers.dev/0:/Stiker_jdm_sepaket_keren_.jpg">
<link rel="icon" type="image/png" sizes="32x32" href="https://file.downloaderku.workers.dev/0:/Stiker_jdm_sepaket_keren_.jpg">
...
<script>window.dataLayer=window.dataLayer || []; function gtag(){dataLayer.push(arguments);}gtag('js', new Date()); gtag('config', 'UA-86099016-6');
</script>
<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src='https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);})(window,document,'script','dataLayer','GTM-MR47R4M');
</script> 
<style>@import url(${themeOptions.cdn}@${themeOptions.version}/goindex-acrou/dist/style.min.css); 
</style> 
<script>window.gdconfig=JSON.parse('${JSON.stringify({version: authConfig.version, themeOptions: themeOptions,})}'); window.themeOptions=JSON.parse('${JSON.stringify(themeOptions)}'); window.gds=JSON.parse('${JSON.stringify( authConfig.roots.map((it)=> it.name) )}'); window.MODEL=JSON.parse('${JSON.stringify(model)}'); 
...
<body>
 <noscript>
 <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-MR47R4M"height="0" width="0" style="display:none;visibility:hidden">
 </iframe>
 </noscript>
 <div id="app">
</div>
...
<div class="navbar2">
  <a href="https://file.downloaderku.workers.dev"><button class="btn1"><i class="fa fa-home"></i> Home</button></a>
  <a href="https://uploader.downloaderku.workers.dev"><button class="btn2"><i class="fa fa-upload"> Upload File</i></button></a>
...
<a style="position:fixed; top:80%; right:2px " href="https://info.flagcounter.com/lHNA"><img src="https://s11.flagcounter.com/count2/lHNA/bg_FFFFFF/txt_000000/border_CCCCCC/columns_2/maxflags_10/viewers_0/labels_0/pageviews_0/flags_0/percent_0/" alt="Flag Counter" border="0"></a>
</body>
...
class googleDrive {
  ...
  basicAuthResponse(request) {
    const user = this.root.user || "",
      pass = this.root.pass || "",
      _401 = new Response("Password yang kamu masukan salah!", {
        headers: {
  ...
  async down(id, range = "", inline = true) {
